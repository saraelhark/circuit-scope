  ...
  >
    <div class="container px-8 sm:px-16 flex h-14 items-center justify-between">
      ...
      <div class="flex items-center gap-1 sm:gap-4">
        <Button
          as="a"
          href="https://github.com/saraelhark/circuit-scope"
          target="_blank"
          rel="noreferrer"
          variant="ghost"
          size="icon"
