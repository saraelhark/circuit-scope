  ...
  >
    <div class="flex flex-col gap-8 lg:flex-row">
      <aside class="w-full lg:w-64 shrink-0 space-y-6">
        <div>
          <h2 class="text-lg font-semibold tracking-tight mb-4 text-white font-primary">
            My Projects
          </h2>
          <nav class="flex flex-col space-y-1">
            ...
            >
              <span class="flex items-center gap-2">
                <i :class="[item.iconClass, 'h-4 w-4']" />
                {{ item.label }}
              </span>
              <span
      ...
      <main class="flex-1 space-y-6">
        ...
        <div class="space-y-4">
          <div
            v-if="status === 'pending'"
            class="py-12 text-center text-white/80"
          >
            Loading projects...
          </div>
          ...
          >
            <h3 class="text-lg font-medium font-primary">
              No projects found
            </h3>
