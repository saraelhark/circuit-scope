    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50">
        <div class="max-w-md w-full">
            ...
            <div class="mt-8 space-y-4">
                <button @click="signIn('github')" :disabled="status === 'loading'"
                    class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50">
                ...
                <button @click="signIn('google')" :disabled="status === 'loading'"
