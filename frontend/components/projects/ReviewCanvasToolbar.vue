...
const activeClass = 'bg-cs-brand border-cs-brand text-white'
const inactiveClass = 'bg-cs-card text-white border-cs-border hover:bg-cs-panel hover:border-cs-brand'
