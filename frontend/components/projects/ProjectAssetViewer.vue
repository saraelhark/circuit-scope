...
<template>
  <div class="space-y-4">
    ...
    >
      <div
        v-if="!views.length"
        class="flex h-[520px] items-center justify-center text-sm text-muted-foreground"
      >
        No views available.
      </div>
      <template v-else>
        <div
          v-if="is3DView"
          class="relative h-[520px] select-none"
        >
          <ProjectModelViewer
            ref="modelViewerRef"
            class="h-full w-full"
        ...
        <div
          ...
          :class="has2DAsset ? 'cursor-grab active:cursor-grabbing' : 'cursor-default'"
        ...
        >
            ...
            >
              <div class="relative flex items-center justify-center">
                ...
                >
                  ...
                  <div
                    v-if="!isAssetLoaded && !isMultiLayer"
          ...
          <div
            ...
            @dblclick.stop
          >
            <h4 class="mb-2 text-xs font-semibold text-cs-charcoal">
              Layers
            </h4>
            <div class="flex flex-col gap-2">
              ...
              >
                <Checkbox
                  ...
                  :class="visibleLayerIds.has(layer.id)
                    ? 'bg-cs-dark-green border-cs-dark-green text-white'
                ...
                <Label
                  :for="`layer-${layer.id}`"
                  class="text-xs cursor-pointer select-none text-cs-charcoal"
                >
                  {{ layer.title }}
                </Label>
              </div>
